 ...
 */
var filer = {
    dayLimit: 10,//39,//после стольких дней файл выкачивается на сервер
    depth: 2,//вложенность папок
    filesLimit: 10,//выкачка фалйов за запуск
    localPath: '/host/projects/contract/upload/',// тоже всё это можно вынести в конфиг
    /**
