...
<tr><td width="50">Name:</td><td> <input type="text" name="add[name]" id="item_name" size="50" value="<?=@$page['name']?>"></td></tr>
<tr><td>alias:</td><td> <input type="text" name="add[alias]" id="item_alias" size="50" value="<?=@$page['alias']?>"></td></tr>
<tr><td>Title:</td><td> <input type="text" name="add[title]" id="item_title" size="50" value="<?=@$page['title']?>"></td></tr>
...
<tr><td>Hidden:</td><td><input type="checkbox" name="add[hidden]" id="item_hidden" value="1" <?if(@$page['hidden']):?> checked<?endif;?>></td></tr>
