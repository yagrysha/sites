...
<textarea  name="add[description]" id="item_description" cols="100" rows="3"><?=@$page['description']?></textarea>
</td></tr>
<tr><td>meta description:</td><td>
<textarea  name="add[meta_description]" id="item_metadescription" cols="100" rows="2"><?=@$page['meta_description']?></textarea>
</td></tr>
<tr><td>Скрытая:</td><td><input type="checkbox" name="add[hidden]" id="item_hidden" value="1" <?if(@$page['hidden']):?> checked<?endif;?>></td></tr>
<tr><td>main:</td><td><input type="checkbox" name="add[ontop]" id="item_ontop" value="1" <?if(@$page['ontop']):?> checked<?endif;?>></td></tr>
...
<tr><td colspan="2"> Comments
<?php
include_once(ROOT_DIR.'/editor/fckeditor.php') ;
$oFCKeditor = new FCKeditor('add[comments]') ;
$oFCKeditor->Height = 300;
$oFCKeditor->BasePath	= '/editor/';
$oFCKeditor->Value		=  @$page['comments'];
$oFCKeditor->Create() ;
?>
</td></tr>
